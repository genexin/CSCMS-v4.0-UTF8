function $Showhtml(){
	...
	player = '<object classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6" width="100%" height="'+parent.cs_height+'" id="mdediaplayer">';
	player += '<param name="URL" value="'+unescape(parent.cs_url)+'">';
	player += '<param name="stretchToFit" value="-1">';
	player += '<embed filename="'+unescape(parent.cs_url)+'" ShowStatusBar="1" type="application/x-mplayer2" width="100%" height="'+parent.cs_height+'">';
	player += '</object>';
